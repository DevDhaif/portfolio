      ...
      <div className={s.shell}>
        <header className={s.topBar}>
          ...
          <div className={s.langToggle}>
            <Link href="/experiments/notebook" className={s.langBtn}>EN</Link>
            <Link href="/experiments/notebook/ar" className={`${s.langBtn} ${s.langBtnActive}`}>ع</Link>
          </div>
        </header>
          ...
          <div className={s.contactWrap}>
            <div className={s.pouch}>
              ...
              <div className={s.pouchItems}>
                ...
                <a className={s.candy} href={SOCIAL_LINKS.TWITTER} target="_blank" rel="noreferrer" style={{ ['--candy-color' as string]: 'var(--st-green)' }}>
                  ✦ تويتر / X
                </a>
              </div>
            </div>
